...
namespace TowerBotLibrary
{
    public class MessageMaker
    {
            ...
            try
            {
                ...
                if (ratificationType == RatificationType.NoRatification)
                {
                    ...
                    if (this.Airplane != null)
                    {
                        ...
                        {
                            Message += TowerBotLibrary.Plugins.HelperPlugin.GetForwardLocationsPhrase(this.Airplane, true, 2);
                        }
                        else
                        {
                            Message += TowerBotLibrary.Plugins.HelperPlugin.GetForwardLocationsPhrase(this.Airplane, true);
                        }
        ...
        private string GetChartPhrase()
        {
            ...
            {
                phrase += TowerBotLibrary.Plugins.HelperPlugin.GetForwardLocationsPhrase(this.Airplane, true, 2);
            }
                ...
                switch (category)
                {
                    ...
                    case MesssageCategory.Taxing:
                        ...
                        if (airplane != null)
                        {
                            ...
                            {
                                newMessage += TowerBotLibrary.Plugins.HelperPlugin.GetForwardLocationsPhrase(airplane, true, 2);
                            }
                            else
                            {
                                newMessage += TowerBotLibrary.Plugins.HelperPlugin.GetForwardLocationsPhrase(airplane, true);
                            }
