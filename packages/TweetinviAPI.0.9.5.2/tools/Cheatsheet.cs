...
namespace Examplinvi
{
    ...
    class Program
    {
        ...
        private static void TweetListExamples()
        {
        ...
        private static void LoggedUser_GetMultipleRelationships()
        {
            var loggedUser = User.GetLoggedUser();
        ...
        private static void TweetList_GetUserLists()
        {
        ...
        private static void TweetList_DestroyList(long listId)
        {
            var list = TweetList.GetExistingList(listId);
        ...
        private static void TweetList_GetTweetsFromList(long listId)
        {
            var list = TweetList.GetExistingList(listId);
